...
function Modal({ children }) {
    _s();
    const overlay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const onClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Modal.useCallback[onClick]": (e)=>{
            if (e.target === overlay.current || e.target === wrapper.current) {
                if (onDismiss) onDismiss();
            }
        }
    }["Modal.useCallback[onClick]"], [
        onDismiss,
        overlay,
        wrapper
    ]);
...
_s(Modal, "OZkpjcKlG+8xMbStdL7++1b3Vas=", false, function() {
    return [
...
//# sourceMappingURL=components_modal_tsx_c025f486._.js.map